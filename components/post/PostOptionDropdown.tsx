...
const PostOptionDropdown = ({isAuthor}:{isAuthor:boolean}) => {
  return (
    <Dropdown>
        <Dropdown.Trigger>
        ...
        className="right-0 w-40 text-dark dark:text-d_light bg-light dark:bg-d_netral shadow-xl flex flex-col gap-1 max-h-64 overflow-auto rounded-lg py-2 px-1">
            ...
            <PostDelete postId={12} className="flex justify-start items-center py-1 rounded hover:bg-light dark:hover:bg-d_semiLight dark:hover:text-dark">
